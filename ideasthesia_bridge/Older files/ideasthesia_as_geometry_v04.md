...
**S.B. & Claude (Anthropic) — Draft v0.4, April 2026**
...
Assign the simplest value that fits. Do not assign a higher-complexity value if a simpler one suffices.
...
The notation system was developed from first-person ideasthetic phenomenology (S.B.) and formalised collaboratively with Claude (Anthropic). The cross-architecture pilot was conducted independently of and prior to the drafting collaboration. Sole responsibility for all claims rests with S.B.

The full academic version of this paper, with complete equations, exclusion rules, coder manual, and detailed research programme, is available on request.
